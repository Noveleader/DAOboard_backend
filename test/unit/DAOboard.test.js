  ...
  : describe("DAO board Unit Tests 🚀🚀", function () {
      ...
      describe("Claiming the tokens by the members...", async function () {
        ...
        it("should transfer tokens correctly", async function () {
          ...
          const initialBalance = await tokenInstance.balanceOf(address.this(memberAddress));
          ...
          const finalBalance = await tokenInstance.balanceOf(address.this(memberAddress));
