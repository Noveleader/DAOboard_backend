...
contract DAOboard is proToken {
    ...
    function returnRegisteredAddresses()
        public
        view
    ...
    function returnTaskRegistrations(
        address walletAddress
    ) public view returns (uint256) {
        return taskRegistrations[walletAddress];
    }

    function returnRegNo(
        address walletAddress
    ) public view returns (string memory) {
        return regNoOf[walletAddress];
    }

    function returnTaskEligible(
        //returns if someone is eligible for task
        uint256 taskId,
        address userAddress
    ) external view returns (bool) {
    ...
    function returnTaskComments(
        //returns any comments made by someone on a task
        uint256 taskId,
        address userAddress
    ...
    function AdminStatus() public view returns (bool) {
    ...
    function giveId(address sender) public view returns (uint256) {
        return Id[sender];
    }
